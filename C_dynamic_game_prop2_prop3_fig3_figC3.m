...
exportgraphics(gcf, 'Figure_3.png', 'Resolution', 300); % Save as PNG with 300 DPI resolution


%% Figure c3 out of Proposition 3: Left panel: Dynamic equilibria for c=c* (case (b)), 
...
% Export the plot as a PNG
exportgraphics(gcf, 'Figure_C3.png', 'Resolution', 300); % Save as PNG with 300 DPI resolution