...
exportgraphics(gcf, 'Figure_4.png', 'Resolution', 300); % Save as PNG with 300 DPI resolution
...
% % Export the plot as a PNG
exportgraphics(gcf, 'Figure_5.png', 'Resolution', 300); % Save as PNG with 300 DPI resolution