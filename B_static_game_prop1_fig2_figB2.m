...
exportgraphics(gcf, 'figure1_new.png', 'Resolution', 300); % Save as PNG with 300 DPI resolution
...
% % Export the plot as a PNG
exportgraphics(gcf, 'figureB2_new.png', 'Resolution', 300); % Save as PNG with 300 DPI resolution
